...
function Dashboard() {
  ...
  const nbaTeams = [
    ...
    { name: 'Rockets', city: 'Houston', abbr: 'HOU', primary: '#CE1141', secondary: '#C4CED4', logo: 'https://a.espncdn.com/i/teamlogos/nba/500/hou.png' },
    ...
    { name: '76ers', city: 'Philadelphia', abbr: 'PHI', primary: '#C4CED4', secondary: '#002B5C', logo: 'https://a.espncdn.com/i/teamlogos/nba/500/phi.png' },
